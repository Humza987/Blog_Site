...
//   //   fetch("/api", {
//   //     method: "POST",
//   //     body: JSON.stringify({ title, author, summary, content, image }),
...
//     if(!title || !author || !summary || !content || !image) {
//       setError(true)
//       return;
//     }
//     setError(false)
...
//     // Handle image file (assuming a single image input)
//     if (image) {
...
//         method: "POST",
//         body: formData, // Send image data with FormData
//       });
...
//               {error && <div style={{marginTop: "10px"}}>Please Fill out all Fields!</div>}
